    ...
    <>
      <div className={style.root}>
        ...
        <div className='content'>
          ...
          <h1>Heurist Imaginaries Airdrop</h1>
          <p>A gift for early supporters of Heurist.  </p>
          <p>Imaginaries are a collection of 500 AI-generated NFTs generated by community-made Stable Diffusion models.</p>
          {!walletAddress && <p>Please connect wallet to Ethereum mainnet</p>}
          ...
          {imageUrl && (
            <>
              ...
              {claimed ? (
                <Button size='large' disabled>Already claimed</Button>
              ) : (
                <Button size='large' onClick={handleClaim} type='primary'>Claim</Button>
              )}
